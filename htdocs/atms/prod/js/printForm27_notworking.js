...
{text:'Registering Authority',style: 'question', alignment: 'right'},
...
{text:[{text:'Name :- ',style: 'question'},{text:vehicle.owner,style: 'answer'},{text:' S/W/D of :- ' ,style: 'question'},{text:vehicle.owner_son_of,style: 'answer'}]},
{text:[{text:'Makers name :- ',style: 'question'},{text:vehicle.makers_name,style: 'answer'}, {text:vehicle.vehicle_description,style: 'answer'}, {text:' Body Type :- ' ,style: 'question'},{text:vehicle.type_of_body,style: 'answer'}]},
{text:[{text:'ULW  :- ',style: 'question'},{text:vehicle.unladen_weight + ' kgs',style: 'answer'},{text:' GVW :- ',style: 'question'},{text:vehicle.gross_vehicle_wt_manf + ' kgs',style: 'answer'}]},
{text:[{text:'Reg. Date  :- ',style: 'question'},{text:vehicle.registration_dt_txt,style: 'answer'}]},
{text:[{text:'HP with  :- ',style: 'question'},{text:vehicle.hire_purchase_details,style: 'answer'}]}
      ],
	  styles: {
     question: {
       fontSize: 8,
