...
{text:[{text:'I/We the undersigned hereby apply for the grant of authorisation valid through the territory for India ',style: 'question'},{text:vehicle.state + ', ALL INDIA',style: 'answer'}]},
  ...
  {columns: [{text:'4. Registration mark of the motor vehicles',style: 'question'},{text:': ' + vehicle.registration_no,style: 'header'} ]},
 ...
 {columns: [{text:'10. Maker of the motor vehicles',style: 'question'},{text:': ' + vehicle.makers_name,style: 'answer'} ]},
  ...
  {columns: [{text:'11. Gross vehicles weight of the motor vehicles',style: 'question'},{text:':  ' + vehicle.gross_vehicle_wt_reg,style: 'answer'} ]},
...
{text:[{text:'Reg. Date  			:- ',style: 'question'},{text:vehicle.registration_dt_txt,style: 'answer'}]},
 ...
 {text:[{text:'\n\n I/ We enclose the Bank Draft of 1000 /- & CHALLAN OF RS 16500 /- as described hereunder towards payment of authorisation ',style: 'question'}]},
 {text:'\n'},
