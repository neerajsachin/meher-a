...
var docDefinition = {
  ...
  {text:vehicle.district + '  ,  ' + vehicle.state,style: 'answer'},
  {text:'',margin: [ 0, 0, 0, 10 ]},
  
{text:[{text:'\n\n   I/We   		' , style:'question' } , {text:vehicle.owner , style:'answer' } , {text:' \n Son/wife/daughter of 		',style:'question'} , {text:vehicle.owner_son_of,style:'answer'},{text:' \n with Home Address - 		' , style:'question'},{text:vehicle.owner_permanent_address,style:'answer'},{text:' \n registered owner of Motor Vehicle No 		',style:'question'}, {text:vehicle.old_vehicle_no,style:'answer'}]},
{text:'\n ,have changed the place of business at the address recorded in the certificate of registration with effect from  ' + dateTxt + '. \n The present address is given below ', style:'question'},
 {text:'',margin: [ 0, 0, 0, 00 ]},
