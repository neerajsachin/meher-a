...
{text:[{text:'The Secretary,S.T.A. , ',style: 'question'},{text:nationalPermitCurrent.authority,style: 'answer'}]},
  {text:'\n'},
  
{text:[{text:'I/We the undersigned hereby apply for the grant of authorisation valid through the territory for India ',style: 'question'},{text:nationalPermitCurrent.authority + ', ALL INDIA',style: 'answer'}]},
  ...
  {columns: [{text:'3. Complete address',style: 'question'},{text:': ' + vehicle.owner_permanent_address,style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
 ...
 {columns: [{text:'9. Permit issuing authority',style: 'question'},{text:': Secy S.T.A. ' + nationalPermitCurrent.authority,style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  
 {columns: [{text:'10. Maker of the motor vehicles',style: 'question'},{text:': ' + vehicle.makers_name,style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},  
  
  {columns: [{text:'11. Gross vehicles weight of the motor vehicles',style: 'question'},{text:':  ' + vehicle.gross_vehicle_wt_manf +'   KGS',style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  
  {columns: [{text:'12. Unladen weight of the motor vehicles',style: 'question'},{text:':  ' + vehicle.unladen_weight +'   KGS',style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  
    {columns: [{text:'13. Pay load of the motor vehicles',style: 'question'},{text:':  ' + vehicle.payload + '   MT',style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
...
{text:[{text:'Reg. Date  		:- ',style: 'question'},{text:vehicle.registration_dt_txt,style: 'answer'}]},
  {text:'\n'},
 {text:[{text:'Make				:- ',style: 'question'},{text:vehicle.makers_name,style: 'answer'}]},
 {text:'\n'},
 ...
 {text:'\n'},
 {text:[{text:'Insurance 		:- ',style: 'question'},{text:vehicle.insurance_upto,style: 'answer'}]}, 
 {text:'\n'},
 ...
 {text:'\n\n'},
 
	 {
	   ...
	   ['1', nationalPermitCurrent.authority, '1000',nationalPermitCurrent.particulars_state,nationalPermitCurrent.payment_date_state_txt],
	   ['2', 'ALL INDIA', '16500','',''],
	  ]},
	 	layout: 'lightHorizontalLines'
	 },
	 {text:'\n\n\n'},
	 {text:' (For S.K Agarwal)',style: 'question', alignment: 'right'},
