myApp.controller('_vehicleCtrl_', function(vehicleService,$routeParams,$scope,$log,companyService,vehicleFactory,$location,taxPaymentFactory,fitnessCertFactory,tempPermitFactory,nationalPermitFactory,companyFactory,commonFactory) {
$scope.listForView =  '';
 $scope.vehicle = {};
...
$scope.confirmDelete = function(itemType, itemID,confirmNumber){
deleteStatusMsg = null;
...
$log.log('vehicle controller delete item for ' + itemType + " - " + itemID );
