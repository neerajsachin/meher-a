function printVehicleForms(vehicle,formNumber){
var today = new Date();
...
vehicle.unladen_weight = (vehicle.unladen_weight)?vehicle.unladen_weight:"";
...
var docDefinition = {
  content: [
  {text:'Form 20,',style: 'header', alignment: 'center'},
  ...
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  {columns: [{text:'8. The Motor Vehicle is (New / Ex-Army/ Imported):',style: 'question'},'']},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  {columns: [{text:'9. Type of body:',style: 'question'},{text:vehicle.type_of_body,style: 'answer'},{text:'',style: 'question'},{text:'',style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  {columns: [{text:'10. Type of vehicle:',style: 'question'},{text:'',style: 'answer'},{text:'23. Colour or Colours of Body',style: 'question'},{text:vehicle.color,style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  ...
  {table:{
	   body:[[ {text:'14. Horse Power:',style: 'question'}, {text:vehicle.hp,style: 'answer'} ],
			[ {text:'15. Cubic Capacity:',style: 'question'}, {text:vehicle.cubic_capacity,style: 'answer'} ],
			
			]
  },layout: 'noBorders'},{text:'25. Gross vehicle weight (Kgs)  \n [a] as certified by the manufacturer:-  '+ vehicle.gross_vehicle_wt_manf + ' \n [b] to be registered:- '+ vehicle.gross_vehicle_wt_reg ,style: 'question'}]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  {columns: [{text:'16. Makers classification /wheel base:',style: 'question'},{text:vehicle.wheel_base,style: 'answer'},{text:'26. Pay Load: - ',style: 'question'},{text:vehicle.payload,style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
...
{columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  ...
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']}	,
  {columns: [{text:'20. Fuel used in the Engine:',style: 'question'},{text:vehicle.fuel,style: 'answer'} ]},
 {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']}	,
