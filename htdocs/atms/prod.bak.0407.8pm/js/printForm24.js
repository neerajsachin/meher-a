...
var docDefinition = {
  ...
  {columns: [{{text:[{text:'Reg. Date  	:- ',style: 'question'},{text:vehicle.registration_dt_txt,style: 'answer'}]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  ...
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  {columns: [{text:'7. If new,ex-army vehicle , or imported vehicle:',style: 'question'}, gap]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  ...
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  {columns: [{text:'11. Type of vehicle:',style: 'question'},{text:vehicle.type_of_vehicle,style: 'answer'} , ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  ...
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
  {columns: [{text:'23. Pay Load: - ',style: 'question'},{text:vehicle.payload,style: 'answer'},{text:'',style: 'question'},{text:'',style: 'answer'} ]},
  {columns: [{text:'',margin: [ 0, 0, 0, 10 ]},'']},
